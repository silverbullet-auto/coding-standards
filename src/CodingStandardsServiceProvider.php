...
class CodingStandardsServiceProvider extends PackageServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->publishes([
            ...
            __DIR__ . '/../tools/coding-standard-tools/grumphp.yml' => base_path('grumphp.yml'),
            __DIR__ . '/../tools/coding-standard-tools/phpunit.xml.dist' => base_path('phpunit.xml.dist'),
        ], 'coding-standards');

        // Publish Code Enforcement GitHub workflows
        $this->publishes([
            __DIR__ . '/../tools/github-workflows/check_standards.yml' => base_path('.github/workflows/check_standards.yml'),
        ], 'github-workflows');
    }
}
